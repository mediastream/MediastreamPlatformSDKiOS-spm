...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "MediastreamPlatformSDKiOS",
      url: "https://s3.amazonaws.com/mediastream-platform-sdk-ios/sdk/dev/6.2.0-dev.21/MediastreamPlatformSDKiOSxC.zip",
      checksum: "9ce72db1c555c330a216fd8082d41910b17a4b4d0b18a17387d116c5dcbfac13"
    ),
    .target(
