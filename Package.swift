...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "MediastreamPlatformSDKiOS",
      url: "https://s3.amazonaws.com/mediastream-platform-sdk-ios/sdk/dev/6.2.0-dev.23/MediastreamPlatformSDKiOSxC.zip",
      checksum: "08670a8b2d60dbe95b071536c1a405a438270f3f8c1541cab75d3c394bacaf50"
    ),
    .target(
